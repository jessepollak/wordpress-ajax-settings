(function(t,i){var s;return s=i.Model.extend({url:ajaxurl+"?action=ajax_settings_save",options:{},sync:function(t,s,e){var n;return e=e||{},e.emulateHTTP=!0,e.contentType="application/json",n=s.toJSON(),n.action="ajax_settings_save_"+this.options.options_name,this.options.network_wide&&(n.network_wide=!0),e.data=JSON.stringify(n),i.Model.prototype.sync.call(this,t,s,e)},parse:function(t,i){return this.options=i,i.form?(this.url=""+ajaxurl+"?action=ajax_settings_save_"+this.options.options_name,this.options.url&&(this.url=this.options.url),this.options.network_wide&&(this.url+="&network_wide=true"),this.$form=this.options.form,_.extend(t,this.$form.serializeObject())):void 0},isNew:function(){return!1},update:function(i){var s;return s=t(i),s.is(":checkbox")&&(i.value=s.is(":checked")?1:0),this.saving=!0,this.save(i.name,i.value,{success:this.saveSuccess.bind(this),error:this.saveError.bind(this)})},saveSuccess:function(t,i){return this.saving=!1},saveError:function(t,i){return this.saving=!1},findInput:function(t,i){return null==i&&(i={}),this._is||(this._is={}),this._is[t]||(this._is[t]=this.$form.find("input, select, textarea").filter("[name='"+t+"']")),this._is[t]}}),t.fn.serializeObject=function(i){var s,e,n,r,o;for(e={},o=t(this).serializeArray(),n=0,r=o.length;r>n;n++)s=o[n],e[s.name]=s.value;return e},s.extend=i.Model.extend,this.AjaxSettingsModel=s}).call(this,jQuery,Backbone);
